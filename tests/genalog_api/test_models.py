...
class TestTextToImageResponse:
    ...
    def test_empty_base64(self):
        ...
        response = TextToImageResponse(
            image_base64="", image_format="jpg", message="Empty image"
        )
    ...
    def test_long_base64_string(self):
        ...
        response = TextToImageResponse(
            image_base64=long_base64, image_format="png", message="Large image"
        )
    ...
    def test_special_characters_in_message(self):
        ...
        assert (
            response.message
            == "Success! Conversion completed with special chars: àáâãäå"
        )
