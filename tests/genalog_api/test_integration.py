...
class TestAPIIntegration:
    ...
    def test_full_text_to_image_workflow(self, client, sample_text, mock_document_generator, sample_image_bytes):
        ...
        with patch("builtins.open") as mock_open_func, \
            ...
            # Setup file mocking
            mock_open_func.return_value.__enter__.return_value.read.return_value = sample_image_bytes
    ...
    def test_file_upload_workflow(self, client, sample_text, mock_document_generator, sample_image_bytes):
    ...
    def test_error_handling_workflow(self, client, sample_text, mock_document_generator):
    ...
    def test_concurrent_requests_simulation(self, client, sample_text, mock_document_generator, sample_image_bytes):
    ...
    def test_different_formats_workflow(self, client, sample_text, mock_document_generator, sample_image_bytes):
