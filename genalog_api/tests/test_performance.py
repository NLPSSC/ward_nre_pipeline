...
class TestPerformance:
    ...
    def test_response_time_convert_text(
        ...
        with (
            ...
            assert (
                response_time < 5.0
            )  # Should respond within 5 seconds (mocked scenario)
    ...
    def test_concurrent_different_formats(
        self, client, sample_text, mock_document_generator, sample_image_bytes
    ):
    ...
    def test_resource_limits_simulation(
        ...
        with (
            ...
            for i in range(5):
                ...
                request_data = {"text": large_text, "width": 2048, "height": 2048}
